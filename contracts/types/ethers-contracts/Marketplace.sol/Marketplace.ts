...
export declare namespace Marketplace {
    ...
    export type ListingStruct = {listingId: BigNumberish, tokenId: BigNumberish, seller: AddressLike, price: BigNumberish, active: boolean, escrowId: BigNumberish, pendingBuyer: AddressLike}

    export type ListingStructOutput = [listingId: bigint, tokenId: bigint, seller: string, price: bigint, active: boolean, escrowId: bigint, pendingBuyer: string] & {listingId: bigint, tokenId: bigint, seller: string, price: bigint, active: boolean, escrowId: bigint, pendingBuyer: string }
  
    }

  export interface MarketplaceInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "buyNFT" | "cancelListing" | "completeSale" | "createListing" | "escrow" | "getActiveListings" | "getListing" | "getRoleAdmin" | "grantRole" | "hasRole" | "landNFT" | "landRegistry" | "pause" | "paused" | "renounceRole" | "revokeRole" | "supportsInterface" | "unpause" | "updatePrice"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "ListingCancelled" | "ListingCreated" | "NFTPurchased" | "Paused" | "PriceUpdated" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "SaleCompleted" | "Unpaused"): EventFragment;
...
encodeFunctionData(functionFragment: 'completeSale', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'completeSale', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'updatePrice', data: BytesLike): Result;
    ...
    export namespace ListingCancelledEvent {
      ...
      export interface OutputObject {listingId: bigint, tokenId: bigint };
    ...
    export namespace ListingCreatedEvent {
      export type InputTuple = [listingId: BigNumberish, tokenId: BigNumberish, seller: AddressLike, price: BigNumberish];
      export type OutputTuple = [listingId: bigint, tokenId: bigint, seller: string, price: bigint];
      export interface OutputObject {listingId: bigint, tokenId: bigint, seller: string, price: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace NFTPurchasedEvent {
      export type InputTuple = [listingId: BigNumberish, tokenId: BigNumberish, buyer: AddressLike, escrowId: BigNumberish];
      export type OutputTuple = [listingId: bigint, tokenId: bigint, buyer: string, escrowId: bigint];
      export interface OutputObject {listingId: bigint, tokenId: bigint, buyer: string, escrowId: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PriceUpdatedEvent {
      export type InputTuple = [listingId: BigNumberish, tokenId: BigNumberish, newPrice: BigNumberish];
      export type OutputTuple = [listingId: bigint, tokenId: bigint, newPrice: bigint];
      export interface OutputObject {listingId: bigint, tokenId: bigint, newPrice: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace SaleCompletedEvent {
      export type InputTuple = [listingId: BigNumberish, tokenId: BigNumberish, buyer: AddressLike];
      export type OutputTuple = [listingId: bigint, tokenId: bigint, buyer: string];
      export interface OutputObject {listingId: bigint, tokenId: bigint, buyer: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    completeSale: TypedContractMethod<
      [listingId: BigNumberish, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'cancelListing'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'completeSale'): TypedContractMethod<
      [listingId: BigNumberish, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'SaleCompleted'): TypedContractEvent<SaleCompletedEvent.InputTuple, SaleCompletedEvent.OutputTuple, SaleCompletedEvent.OutputObject>;
getEvent(key: 'Unpaused'): TypedContractEvent<UnpausedEvent.InputTuple, UnpausedEvent.OutputTuple, UnpausedEvent.OutputObject>;

    filters: {
      
      'ListingCancelled(uint256,uint256)': TypedContractEvent<ListingCancelledEvent.InputTuple, ListingCancelledEvent.OutputTuple, ListingCancelledEvent.OutputObject>;
      ...
      'ListingCreated(uint256,uint256,address,uint256)': TypedContractEvent<ListingCreatedEvent.InputTuple, ListingCreatedEvent.OutputTuple, ListingCreatedEvent.OutputObject>;
      ...
      'NFTPurchased(uint256,uint256,address,uint256)': TypedContractEvent<NFTPurchasedEvent.InputTuple, NFTPurchasedEvent.OutputTuple, NFTPurchasedEvent.OutputObject>;
      ...
      'SaleCompleted(uint256,uint256,address)': TypedContractEvent<SaleCompletedEvent.InputTuple, SaleCompletedEvent.OutputTuple, SaleCompletedEvent.OutputObject>;
      SaleCompleted: TypedContractEvent<SaleCompletedEvent.InputTuple, SaleCompletedEvent.OutputTuple, SaleCompletedEvent.OutputObject>;
